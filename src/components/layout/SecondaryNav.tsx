...
export function SecondaryNav({ activeItem, onItemChange }: SecondaryNavProps) {
  return (
    <nav className="h-full w-full overflow-x-auto
      ...
      scrollbar-hide ">
      {/* Outer Card */}
      <div className="bg-card lg:space-y-2 flex lg:flex-col w-full gap-2 width-scroll lg:gap-2 px-2  flex-nowrap   after:content-[''] after:w-2 after:flex-shrink-0 py-2">
        {navItems.map((item) => {
