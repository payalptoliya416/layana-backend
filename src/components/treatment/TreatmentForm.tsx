 ...
 useEffect(() => {
  getTreatmentCategories()
    .then((data) => {
      ...
      // ✅ IF creating new & category empty → select first
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* NAME */}
        <div>
          <label className="text-sm font-medium">Name <sup className="text-red-500">*</sup ></label>
          <input className="form-input" {...register("name")} placeholder="Enter treatment name"/>
          {errors.name && (
        ...
        {/* STATUS */}
        <div>
          <label className="text-sm font-medium">Status <sup className="text-red-500">*</sup ></label>
          <Select
  value={status}
  onValueChange={(v) =>
    ...
    <SelectItem value="published">Published</SelectItem>
        ...
        <div>
          <label className="text-sm font-medium">
            Indicative Pressure <sup className="text-red-500">*</sup >
          </label>
         <Select
...
>
  ...
  <SelectContent>
    ...
    <SelectItem value="strong">Deep</SelectItem>
        ...
        {/* CATEGORY */}
        <div>
          <label className="text-sm font-medium">Category <sup className="text-red-500">*</sup ></label>
         <Select
  value={category}
  onValueChange={(v) =>
    setValue("category", v, {
...
>
  ...
  <SelectContent>
    {categories.map((c) => (
      ...
      {/* CONTENT */}
      <div>
        <label className="text-sm font-medium">Content <sup className="text-red-500">*</sup ></label>
        <DescriptionEditor
          value={content || ""}
          onChange={(val) =>
