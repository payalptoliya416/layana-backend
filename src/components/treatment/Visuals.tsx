...
>(function VisualsForm({ onChange, initialData, category }, ref) {
  ...
  const handleGallerySelect = (files: FileList) => {
    ...
    // ✅ Small delay so React state updates properly
    setTimeout(() => {
      setCropQueue(urls);
      setCurrentCropIndex(0);
      setCropImage(urls[0]);
  ...
  return (
    <div className="space-y-6">
      ...
      <form className="rounded-[15px] border border-border bg-card px-5 py-5">
        {/* Heading */}
        <h3 className="mb-6 text-lg font-semibold text-foreground">Buttons</h3>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              Button 1{" "}
              {!isFacial && <sup className="text-destructive"> * </sup>}
            </label>
