    ...
    <>
        ...
        <div className="container mx-auto">
          <div className="border-[10px] border-[#F6F6F6] py-[60px] px-5 md:px-10 lg:px-[55px]">
            <div className="text-center mb-5">
              <span className="inline-block bg-[#F7EFEC] text-base lg:text-[22px] leading-[24px] mb-5 tracking-wider py-[10px] px-5 lg:px-[35px] text-[#282828]">
            ...
            <p className="text-center italic font-muli text-[22px] leading-[24px] mb-[35px]  text-[#282828]">
      ...
      <section className="pb-12 lg:pb-[110px]">
        <div className="container mx-auto">
          ...
          <div className="pt-[35px] max-w-3xl mx-auto">
            <h2 className="text-[#282828] text-base md:text-[22px] mb-[30px] font-muli italic">
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-[50px]">
          ...
          <ul className="text-base text-[#666666] space-y-2 font-quattro">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-y-16 gap-x-40">
          ...
          <div>
            ...
            <p className="text-[#666666] font-quattro text-base">
