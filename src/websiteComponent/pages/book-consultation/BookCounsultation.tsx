                                ...
                                <>
                                    <div className="grid grid-cols-12 sm:gap-[25px] sm:gap-y-[30px]">
                                        {skincareOptions.map((item) => (
                                            <div key={item.value} className="col-span-12 sm:col-span-6 lg:col-span-3">
                                                <label
                                    ...
                                    <div className="flex justify-between items-center mt-5">
                                        ...
                                        <div className="w-10 h-10 border border-black flex justify-center items-center cursor-pointer" onClick={() => step < 5 && handleNext()}>
                                            <LuMoveRight />
                                        </div>
                                    </div>
                                </>
